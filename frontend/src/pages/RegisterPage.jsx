    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-6 py-12 bg-dark-800">
            <div className="absolute inset-0">
                <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-80 h-80 bg-[#39FF14]/5 rounded-full blur-3xl"></div>
            </div>
            ...
            <div className="relative w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="glass-card rounded-2xl p-6 md:p-8 space-y-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full bg-[#111] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#39FF14]/50 transition-all"
                        >
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full flex items-center justify-center gap-2 bg-[#39FF14] text-black font-bold py-3.5 rounded-xl neon-glow hover:bg-[#2bcc10] transition-all disabled:opacity-60 disabled:cursor-not-allowed mt-2"
                    >
                        {loading ? (
                ...
                <p className="text-center text-gray-500 mt-5 text-sm">
                    ...
                    <Link to="/login" className="text-[#39FF14] hover:underline font-medium">Sign In</Link>
                </p>
            </div>
        </div>
    );
