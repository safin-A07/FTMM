        ...
        <div className="min-h-screen flex items-center justify-center px-6 bg-dark-800">
            ...
            <div className="relative w-full max-w-md">
                ...
                <p className="text-center text-gray-500 mt-5 text-sm">
                    ...
                    <Link to="/register" className="text-[#39FF14] hover:underline font-medium">Register</Link>
                </p>
                <button
                    onClick={() => authClient.signIn.social({ provider: "google" })}
                    className="w-full mt-4 flex items-center justify-center gap-2 bg-white text-black font-bold py-3 rounded-xl hover:bg-gray-200 transition-all"
                >
